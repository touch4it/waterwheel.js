...
module.exports = class OAuth {
  constructor(basePath, OAuthOptions) {
    ...
    if (OAuthOptions.hasOwnProperty('tokenExpireTime')) {
      this.tokenExpireTime = OAuthOptions.tokenExpireTime;
    }
    this.tokenInformation = Object.assign({}, _.omit(OAuthOptions, ['tokenExpireTime']));
